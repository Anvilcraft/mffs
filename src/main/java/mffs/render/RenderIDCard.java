...
public class RenderIDCard implements IItemRenderer {
  ...
  public RenderIDCard() { this.mc = Minecraft.getMinecraft(); }

  public void renderItem(final IItemRenderer.ItemRenderType type,
                         final ItemStack itemStack, final Object... data) {
  ...
  private void transform(final IItemRenderer.ItemRenderType type) {
    ...
    if (type == IItemRenderer.ItemRenderType.ENTITY) {
      ...
      GL11.glRotatef(Minecraft.getSystemTime() / 12.0f % 360.0f, 0.0f, 1.0f,
                     0.0f);
  ...
  //TODO: WTF
  //@Override
  private void renderItem3D(final EntityLiving par1EntityLiving,
    ...
    ItemRenderer.renderItemIn2D(tessellator, f2, f3, f, f4, icon.getIconWidth(),
    ...
    if (par2ItemStack != null && par2ItemStack.hasEffect(0) && par3 == 0) {
      ...
      this.mc.renderEngine.bindTexture(new ResourceLocation(
          "%blur%/textures/misc/enchanted_item_glint.png"));
      GL11.glEnable(3042);
      ...
      ItemRenderer.renderItemIn2D(tessellator, 0.0f, 0.0f, 1.0f, 1.0f, 256, 256,
                                  0.0625f);
      GL11.glPopMatrix();
      GL11.glPushMatrix();
      GL11.glScalef(f9, f9, f9);
  ...
  public boolean
  shouldUseRenderHelper(final IItemRenderer.ItemRenderType type,

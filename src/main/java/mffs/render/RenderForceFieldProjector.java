...
public class RenderForceFieldProjector extends TileEntitySpecialRenderer {
  ...
  public void renderTileEntityAt(final TileEntity t, final double x,
    ...
    if (t instanceof TileEntityForceFieldProjector) {
      ...
      if (tileEntity.getMode() != null) {
        ...
        tessellator.addVertex(-0.866 * width, (double)height,
                              (double)(-0.5f * width));
        tessellator.addVertex(0.866 * width, (double)height,
                              (double)(-0.5f * width));
  ...
  static { MODEL = new ModelForceFieldProjector(); }
}

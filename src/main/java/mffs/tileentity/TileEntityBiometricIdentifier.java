...
public class TileEntityBiometricIdentifier
  ...
  @Override
  public boolean isAccessGranted(final String username,
    ...
    for (int i = 0; i < this.getSizeInventory(); ++i) {
      ...
      if (itemStack != null &&
          itemStack.getItem() instanceof ICardIdentification &&
          username.equalsIgnoreCase(((ICardIdentification)itemStack.getItem())
  ...
  public void onReceivePacket(PacketTile.Type type, final NBTTagCompound nbt) {
    ...
    } else if (type == PacketTile.Type.STRING &&
               this.getManipulatingCard() != null) {
      final ICardIdentification idCard =
          (ICardIdentification)this.getManipulatingCard().getItem();
      idCard.setUsername(this.getManipulatingCard(), nbt.getString("s"));
    }
  }
  ...
  @Override
  public int getSizeInventory() { return 13; }

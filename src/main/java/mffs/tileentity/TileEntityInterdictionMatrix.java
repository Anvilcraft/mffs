...
public class TileEntityInterdictionMatrix
  ...
  public void updateEntity() {
    ...
    if (!this.getWorldObj().isRemote &&
        (this.isActive() || (this.getStackInSlot(0) != null &&
    ...
    try {
      ...
      final List<EntityLivingBase> warningList =
          this.getWorldObj().getEntitiesWithinAABB(
              ...
              emptyBounds.expand((double)this.getWarningRange(),
                                 (double)this.getWarningRange(),
                                 (double)this.getWarningRange()));
      final List<EntityLivingBase> actionList =
          this.getWorldObj().getEntitiesWithinAABB(
              EntityLivingBase.class,
              emptyBounds.expand((double)this.getActionRange(),
  ...
  public boolean isBanMode() { return this.isBanMode; }
  ...
  public int getWarningRange() {
    return this.getModuleCount(ModularForceFieldSystem.itemModuleWarn,
                               new int[0]) +
  ...
  public boolean isItemValidForSlot(final int slotID,
    ...
    return slotID > super.endModuleIndex || itemStack.getItem() instanceof
                                                IModule;
  }
